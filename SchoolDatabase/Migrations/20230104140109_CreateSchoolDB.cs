        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    NeptunId = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                    Name = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "CourseTeacher (Dictionary<string, object>)",
                columns: table => new
                {
                    CoursesId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CourseTeacher (Dictionary<string, object>)", x => new { x.CoursesId, x.TeachersId });
                    table.ForeignKey(
                        name: "FK_CourseTeacher (Dictionary<string, object>)_Course_CoursesId",
                        column: x => x.CoursesId,
                        principalTable: "Course",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CourseTeacher (Dictionary<string, object>)_Teacher_TeachersId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourseTeacher (Dictionary<string, object>)_TeachersId",
                table: "CourseTeacher (Dictionary<string, object>)",
                column: "TeachersId");
